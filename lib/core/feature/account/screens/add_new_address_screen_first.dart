...
class AddNewAddressScreenFirst extends StatefulWidget {
  const AddNewAddressScreenFirst({super.key});

  @override
  State<AddNewAddressScreenFirst> createState() =>
      _AddNewAddressScreenFirstState();
}

class _AddNewAddressScreenFirstState extends State<AddNewAddressScreenFirst> {
  ...
  void getSuggession(String input) async {
    String kPLACES_API_KEY = 'AIzaSyBaY6jg8aoeQ1sQLP0xUdhXqAiMIa4HYcU';
    String baseURL =
